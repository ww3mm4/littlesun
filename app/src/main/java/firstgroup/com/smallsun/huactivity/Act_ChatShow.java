...
import firstgroup.com.smallsun.qunactivity.PersonalinformationActivity;
...
public class Act_ChatShow extends Activity {
...
//        mCustomUserID = getIntent().getExtras().getString("CustomUserID");
        ...
        if (mCustomUserID == null) {
            ...
            mCustomUserID = IMMyself.getCustomUserID();
        }
        ...
        //设置title
        mChatView.setTitleBarBackgroundColor(getResources().getColor(R.color.text_orang_color));
        ...
        //设置title标题
        //mChatView.setTitle("自定义标题");

        //标题栏右边按钮
        mChatView.setRightTitleBarImage(R.drawable.tt_hisrecords);
        ...
        //聊天背景
        if ("hu".equals(IMMyself.getCustomUserID())) {
            mChatView.setChatViewBackground(R.drawable.lingling);
        } else {
            mChatView.setChatViewBackground(R.drawable.bgm2);
        }
        //聊天时间显示
        ...
        mChatView.setOnChatCustomChatViewInitListener(new IMChatView.OnChatCustomChatViewInitListener() {
            ...
            public void onInitView(IMCustomRView v, String message, boolean isRecv) {
                ...
                if (v.getTag() != null) {
                    ...
                    cv = new TTCustomChatView(Act_ChatShow.this);
        ...
        mChatView.setOnChatCustomTipsViewInitListener(new IMChatView.OnChatCustomTipsViewInitListener() {
            ...
            public void onInitView(IMCustomLView v, String message, boolean isRecv) {
                ...
                if (v.getTag() != null) {
                    ...
                    cv = new TTCustomTipsView(Act_ChatShow.this);
...
//		mChatView.setChatSystemTipsTextColor(color);
        ...
        //返回按钮监听
        //当设置此监听时，需要自己来finish Activity
        mChatView.setOnLeftTitleBarClickListener(new View.OnClickListener() {

            @Override
            public void onClick(View v) {
                Act_ChatShow.this.finish();
        ...
        mChatView.setOnHeadPhotoClickListener(new IMChatView.OnHeadPhotoClickListener() {
            ...
            public void onClick(View v, String customUserID) {
                ...
                Intent intent = new Intent(Act_ChatShow.this, PersonalinformationActivity.class);
