 ...
 */
public class PullDoorView extends PercentRelativeLayout {
    ...
    private void setupView() {
        ...
        this.setBackgroundColor(Color.argb(80, 200, 200, 200));
        ...
        mImgView.setImageResource(R.drawable.re_bg); // 默认背景
        addView(mImgView);
    }
